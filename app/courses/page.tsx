        ...
        <Card className="shadow-lg mb-6">
          <CardContent className="pt-6">
            <div className="relative">
              ...
              <Input
                placeholder="Search courses by title, description, or course code..."
                value={searchTerm}
                onChange={(e) => {
                            ...
                            >
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                  <div className="flex-shrink-0 w-1 h-8 bg-gradient-to-b from-blue-600 to-purple-600 rounded group-hover:w-1.5 transition-all"></div>
